...
let heroBanner={enabled:true,kicker:"🛒 أمازون هايبر ماركت",title:"كل احتياجات بيتك",strongTitle:"بخطوات أسهل وأسرع",text:"اختَر القسم، أضف احتياجاتك إلى السلة، ونحن نهتم بالباقي 🚚",buttonText:"ابدأ التسوق الآن ←",buttonAction:"#categories",art:"🛒"};
let heroBanners=[];let heroIndex=0;let heroTimer=null;
function getHeroSlides(){return(Array.isArray(heroBanners)&&heroBanners.length?heroBanners:[heroBanner]).filter(x=>x&&x.enabled!==false);}
